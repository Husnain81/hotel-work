...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $today_order_quantity= $_POST['today_order_quantity'] ?? '';
    ...
    $sql = "UPDATE users SET username = '$member_account', number = '$member_phone', total_balance='$total_balance', today_order_quantity='$today_order_quantity', member_level = '$member_level', member_status = '$member_status' WHERE id = '$user_id'"; 
    // var_dump($sql); exit;
