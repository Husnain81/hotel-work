...
// Disable button
if (isset($_POST['disable_user']) && isset($_POST['user_id'])) {
    $id = $_POST['user_id'];
...
// Enable button
if (isset($_POST['enable_user']) && isset($_POST['user_id'])) {
    $id = $_POST['user_id'];
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <!-- <td class="border border-gray-300 p-2 text-center"><?php //echo $user['superior_id'] 
                                                                            ?></td> -->
                    <!-- <td class="border border-gray-300 p-2 text-center"><?php //echo $user['num_subordinate_members'] 
                                                                            ?></td> -->
                    <!-- <td class="border border-gray-300 p-2 text-center"><?php //echo $user['max_daily_statements'] 
                                                                            ?></td> -->
                    ...
                    <!-- <td class="border border-gray-300 p-2 text-center"><?php //echo $user['total_commission'] 
                                                                            ?></td> -->
                    ...
                    <td class="border border-gray-300 p-2 text-center sticky space-y-2" id="operate-btns">
                      <button
                        ...
                        data-totalBalance="<?php echo htmlspecialchars($user['total_balance']); ?>"
                        data-todayOrderQuantity="<?php echo htmlspecialchars($user['today_order_quantity']); ?>"
    ...
    <div id="edit-form" class="edit-form" style="display: none;"> <!-- Make sure it starts as hidden -->
      ...
      <form action="update_user.php" method="post" id="editUserForm">
        ...
        <div class="flex items-center mb-3">
          <label for="">ID</label>
          <input type="text" name="user_id_display" placeholder="123" value="" disabled style="cursor: not-allowed;">
        </div>
        <div class="flex items-center mb-3">
        ...
        <div class="flex items-center mb-3">
          ...
          <input type="tel" name="total_balance" value="" placeholder="3994756505" required>
        </div>
        <div class="flex items-center mb-3">
          <label for="">Today Order Quantity</label>
          <input type="text" name="today_order_quantity" placeholder="10" value="" required>
        </div>
        <div class="flex items-center mb-3">
    ...
    <div id="system-increase-decrease" style="display: none; max-width: 600px; max-height: 80vh; overflow-y: auto; background: white; padding: 20px; border-radius: 8px; margin: auto; position: relative; top: 50%; transform: translateY(-50%);">
      ...
      <form action="insert_data.php" method="post">
        <div class="flex items-center mb-3">
          ...
          <input type="hidden" name="transaction_id" id="transaction-id" value="<?php echo $user['id'] ?>"> <!-- Hidden input field -->
          <input type="text" placeholder="<?php echo $user['id'] ?>" disabled style="cursor: not-allowed;">
        </div>
        <div class="flex items-center mb-3">
  ...
  <script>
    ...
    editButtons.forEach(button => {
      button.addEventListener('click', function() {
        ...
        const totalBalance = this.getAttribute('data-totalBalance');
        const todayOrderQuantity = this.getAttribute('data-todayOrderQuantity');
        ...
        editForm.querySelector('input[name="user_id_display"]').value = userId || '';
        ...
        editForm.querySelector('input[name="total_balance"]').value = totalBalance || '';
        editForm.querySelector('input[name="today_order_quantity"]').value = todayOrderQuantity || '';
